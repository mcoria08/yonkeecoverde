...
<head>
    ...
    <head>
        ...
        > </style>
        > <![endif]-->
        <title>YonkeEcoVerde - Registro de Usuario</title>
        <style type="text/css">
            div, p, a, li, td {
                    ...
                    <td><table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="background-color:#ffffff; border-radius:5px 5px 0 0;">
                            <tr>
                                <td><table width="265" align="left" border="0" cellspacing="0" cellpadding="0" class="inner" style="text-align:center;">
                                        ...
                                        <tr>
                                            <td width="28">&nbsp;</td>
                                            <td align="center" valign="middle"><a href="#"><img src="https://yonke.ecoverde.mx/vendor/adminlte/dist/img/logo-yonke-ecoverde.png" width="125" height="142" alt="YonkeEcoVerde"></a></td>
                                        </tr>
                                        <tr>
                                        </tr>
                                    </table>
                                        ...
                                        <tr>
                                            <td align="center" valign="middle">
                                                <table width="191" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                                    <tr>
                                                        <td align="center" bgcolor="#d8262f" height="57" style="border-radius:28px;"><a href="https://yonke.ecoverde.mx/login" style="font-family:'Montserrat', Helvetica, Arial, sans-serif; font-weight:700; font-size:16px; line-height:57px; color:#ffffff; text-decoration:none; text-transform:uppercase; display:block; overflow:hidden; ">IR AL SITIO WEB</a></td>
                                                    </tr>
                                                </table>
    ...
    <tr>
        <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
                <tr>
                    <td>
                        <table width="100%" bgcolor="#f8f8f8"  border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="text-align:center;">
                            <tr>
                                <td class="heightsmalldevices" height="58">&nbsp;</td>
                            </tr>
                            <tr>
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;">
                                        <tr>
                                            <td width="26">&nbsp;</td>
                                            <td align="left" style="font:bold 18px Arial, Helvetica, sans-serif; color:#404040;">Registro de Usuario</td>
                                            <td width="26">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td width="26">&nbsp;</td>
                                            <td align="left" style="font: 14px/24px Arial, Helvetica, sans-serif; color:#404040;">
                                        ...
                                        <tr>
                                            <td width="26">&nbsp;</td>
                                            <td class="heightsmalldevices" height="62">&nbsp;</td>
                                            <td width="26">&nbsp;</td>
                                        </tr>
                                    </table>
    ...
    <tr>
        <td align="center">
            <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
                <tr>
                    <td>
                        <table width="100%" bgcolor="#d8262f" border="0" cellspacing="0" cellpadding="0" align="center" class="full" style="border-radius:0 0 5px 5px;">
                                ...
                                <td>
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                    <tr><td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" class="full">
                                                                <tr>
                                                                    <td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#383838;"><a style="color:#ffffff; text-decoration:none;" href="#"></a> </td>
                                    ...
                                    <table width="230" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt; text-align:center;" class="inner">
                                        <tr>
                                            ...
                                            <td>
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                                    <tr><td align="center" style="font:11px Helvetica,  Arial, sans-serif; color:#ffffff;">&copy; 2024, YonkeEcoVerde
                                                        </td></tr>
                                                    <tr><td height="18">&nbsp;</td></tr>
                                                </table>
